...
"}")
        ...
        self.label_title.setGeometry(QRect(0, 80, 661, 70))
        font = QFont()
...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>CodeDoxs</strong>", None))
        ...
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>Created</strong>: M.Aryia-Behroziuan", None))
    # retranslateUi
